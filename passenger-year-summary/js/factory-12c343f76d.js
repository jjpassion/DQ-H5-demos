! function () {
	...
	f.getShareImg = function (info) {
		...
		var shareInfo = ['image/share/1-05178db119.jpg','image/share/2-72f30f17dc.jpg','image/share/3-4fd2cc42cb.jpg','image/share/4-43b5b35374.jpg','image/share/5-339422ec94.jpg','image/share/6-c3078afc4b.jpg','image/share/7-6fbb166ec9.jpg','image/share/8-83a0dd5f5a.jpg','image/share/9-2c027aa76a.jpg']
		...
		var shareAnTips = ['image/share_an_1-f575f449a7.png','image/share_an_2-91268a34d2.png','image/share_an_3-99411ca56c.png','image/share_an_4-151ac389f7.png','image/share_an_5-e59430abdd.png','image/share_an_6-bc8cc97eb0.png','image/share_an_7-e59430abdd.png','image/share_an_8-f7fc47c825.png','image/share_an_9-b54d9e1dd6.png'];
		...
		$(".name").text(info.name);
		$(".share-info").attr('src', f.isWeiXinAndZFB() ? __urlPrefix + shareTips[type - 1] : __urlPrefix + shareAnTips[type - 1]);
		$(".end-info").attr('src', __urlPrefix + endInfo[type - 1]);
		var image = new Image();
		image.onload = function () {
			...
			if (f.isWeiXinAndZFB()) {
				...
				setTimeout(function () {
					...
					html2canvas(document.querySelector("#share-con"), {
						canvas: $("share-canvas")[0]
					}).then(canvas => {
		...
		$(".share-bg").attr('src', __urlPrefix + shareInfo[type - 1]);
		...
		image.src = __urlPrefix + shareInfo[type - 1];
	...
	f.setBASE = function (url, callback) {
		...
		$.getJSON(__urlPrefix + url, function (data, textStatus, jqxhr) {
